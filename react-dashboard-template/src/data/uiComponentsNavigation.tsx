    ...
    children: [
      ...
      { title: "Parallax", path: "/components/parallax", icon: <ViewHeadline /> },
      {
        ...
        children: [
          ...
          { title: "TIme Pickers", path: "/components/pickers/time-pickers", icon: <Timer /> },
        ],
      },
      {
        title: "Progress",
      ...
      { title: "Subheaders", path: "/components/subheaders", icon: <ViewHeadline /> },
      {
        title: "Tables",
        children: [
      ...
      { title: "VirtualScrollers", path: "/components/virtual-scrollers", icon: <ViewHeadline />, badge: "new" },
    ],
  },
  { header: "Directives" },
  {
    ...
    children: [
      ...
      { title: "Ripples", badge: "new", path: "/directives/ripples" },
      { title: "Scrolling", badge: "new", path: "/directives/scrolling" },
    ],
  },
  { header: "Guide" },
  {
